...
## Introduction to programming in NIMBLE with nimbleFunctions
 ...
 - [nimbleFunction example: maximum (modules/marginal) likelihood](modules/basic_nimbleFunction_slides.html) 
...
## Writing algorithms with Sequential Monte Carlo as an example
 ...
 - [Revisiting reproducibile methods](modules/reproducibility_revisited_slides.html)
