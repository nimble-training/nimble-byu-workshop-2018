...
Then the dinterval probability is one only if `x[i] > c[i]`.
...
jaw-linear - dmnorm model
bones: dcat with probs
lsat: rasch model with prod/T/mean
beetles: post-pred stuff
biops: ddirch/dmulti with error
spatial model?

# Open discussion of participant models
