...
# Marginalization and data augmentation
 ...
 - Data augmentation:
   - Examples:
     ...
     - t distribution as mixture of normal distributions (see Gelman et al. Bayesian Data Analysis)
   - Advantages
   ...
   - Disadvantages
     ...
     - More 'level' increases dependence across levels; moves parameters 'further' from data
