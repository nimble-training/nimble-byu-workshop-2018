...
cmprobit2 = compileNimble(mprobit2)
set.seed(1)
system.time(
props2 <- cmprobit(alphas, M)
)
system.time(
props3 <- cmprobit2(alphas, M)
)
```
...
# Using nimbleFunctions in BUGS code
...
Examples in my own work:
 ...
 - writing a linearized exponential function, $1(x<0) \exp(x) + 1(x \geq 0) (1 + x)$, to robustify an exponential transformation
 - writing a b-spline function
