...
margSampler <- nimbleFunction(
            ...
            run = function(samples = double(2)) {
                  ...
                  nIts <- dim(samples)[1]
                  resize(newMV, nIts)
                  ## the next line is a bug work-around and should not be necessary shortly
                  samplerExecutionOrder <- nimInteger(1, value = -1)
                  ...
                  for(i in 1:nIts) {
                      ...
                      mcmc$run(1, reset = FALSE, progressBar = FALSE,
                          samplerExecutionOrder = samplerExecutionOrder)
                          ## again, the 'samplerExecutionOrder argument is only a bug work-around
