...
# NIMBLE's dialect of BUGS
   ...
   - The BUGS syntax used in NIMBLE has minor differences from that used in WinBUGS, OpenBUGS and/or JAGS. We'll see some of this as we go along, in particular in the [module on NIMBLE's dialet of BUGS](3.1_nimble_bugs_slides.html).
